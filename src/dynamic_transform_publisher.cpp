...
int main(int argc, char** argv)
{
    ...
    if(argc == 11)
    {
      ...
      tf_sender.set(atof(argv[1]), atof(argv[2]), atof(argv[3]), atof(argv[4]), atof(argv[5]), atof(argv[6]), atof(argv[7]), argv[8], argv[9], atof(argv[10]));
    }
    else if (argc == 10)
    {
      ...
      tf_sender.set(atof(argv[1]), atof(argv[2]), atof(argv[3]), atof(argv[4]), atof(argv[5]), atof(argv[6]), argv[7], argv[8], atof(argv[9]));
    }
    else if(argc==1)
    {
